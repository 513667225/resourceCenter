layui.use(['table','form'], function () {
    ...
    table.render({
        ...
        cols: [[
            ...
            {field: 'goodsName', title: '国家', sort: true},
            {field: 'goodsGallery', title: '宣传图片', width: 120, toolbar: '#checkGoodsPicDetail', align: 'center'},
            {field: 'goodsPrice', width: 80, title: 'ASIN', align: 'center'},
            {field: 'categoryName', width: 110, title: '类目', sort: true, align: 'center'},
            ...
            //     }
            // },
            {field: 'goodsUnit', width: 70, title: '店铺', align: 'center'},
            {field: 'goodsUnit', width: 70, title: '客户', align: 'center'},
